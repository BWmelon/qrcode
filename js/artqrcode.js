...
(function () {
    ...
    var Drawing = (function () {
        ...
        var Drawing = function (el, htOption) {
            ...
            this._elImage.id = "art-qrcode";
            this._elImage.classList = "img-responsive center-block";
    ...
    QRCodeA = function (el, vOption,callback) {
        this._htOption = {
            width: 256,
            height: 256,
            bgWidth: 256,
    ...
    QRCodeA.prototype.makeCode = function (sText) {
     ...
     * load all materials
     */
    QRCodeA.prototype.loadMaterial = function (sText) {
        var self = this;
        var count = 0;
     ...
     * @private
     */
    QRCodeA.prototype.makeImage = function () {
     ...
     * Clear the QRCode
     */
    QRCodeA.prototype.clear = function () {
     ...
     */
    QRCodeA.prototype.getImgUrl = function () {
     ...
     */
    QRCodeA.CorrectLevel = QRErrorCorrectLevel;
})();
